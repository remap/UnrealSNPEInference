 ...
 */
  static bool isRuntimeAvailable(DlSystem::Runtime_t runtime, uint32_t deviceId = 0){
    return (bool)Snpe_Util_IsRuntimeAvailableForDevice(static_cast<Snpe_Runtime_t>(runtime), deviceId);
  }
 ...
 */
  static bool isRuntimeAvailable(DlSystem::Runtime_t runtime, DlSystem::RuntimeCheckOption_t option,
                                                              uint32_t deviceId = 0){
    return (bool)Snpe_Util_IsRuntimeAvailableCheckOptionForDevice(static_cast<Snpe_Runtime_t>(runtime),
 ...
 */
  static bool isGLCLInteropSupported(){
    return (bool)Snpe_Util_IsGLCLInteropSupported();
  }
 ...
 */
  static bool initializeLogging(const DlSystem::LogLevel_t& level){
    return (bool)Snpe_Util_InitializeLogging(static_cast<Snpe_LogLevel_t>(level));
  }
 ...
 */
  static bool initializeLogging(const DlSystem::LogLevel_t& level, const std::string& logPath){
    return (bool)Snpe_Util_InitializeLoggingPath(static_cast<Snpe_LogLevel_t>(level), logPath.c_str());
  }
 ...
 */
  static bool setLogLevel(const DlSystem::LogLevel_t& level){
    return (bool)Snpe_Util_SetLogLevel(static_cast<Snpe_LogLevel_t>(level));
  }
 ...
 */
  static bool terminateLogging(){
    return (bool)Snpe_Util_TerminateLogging();
  }
};
